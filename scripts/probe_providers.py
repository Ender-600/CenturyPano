...
The default order is OpenAI, Gemini, then fal. Configured probes incur provider usage.
...
def main() -> int:
    ...
    parser.add_argument("--provider", choices=("all", "openai", "gemini", "fal"), default="all")
    ...
    providers = ["openai", "gemini", "fal"] if args.provider == "all" else [args.provider]
    try:
