...
app access code in Settings (or use the private access link). Phone orientation
and GPS walking start automatically after browser permissions and compass
alignment. The three views and compass controls are in Settings. To prepare
future historical images, choose **Start panorama walk** there. Provider API
