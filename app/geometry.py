...
def preprocess(source: bytes | str | Path | Image.Image, is_360: bool | None = None) -> Preprocessed:
    ...
    warnings = []
    if width / height < 2.0:
        warnings.append("This photo looks narrow. Use panorama mode for a better experience.")
    ...
    if working_width != original_working_width:
        warnings.append("The panorama has been resized horizontally to fit within eight overlapping tiles.")
